//
// Copyright Aliaksei Levin (levlam@yoyomessenger.ir), Arseny Smirnov (arseny30@gmail.com) 2014-2021
//
...
#else
  if (is_test) {
    add_ip_ports(1, {"79.132.207.178"}, ports);
    add_ip_ports(2, {"79.132.207.178"}, ports);
    ...
    add_ip_ports(1, {"79.132.207.178"}, ports);
    add_ip_ports(2, {"79.132.207.178", "79.132.207.178"}, ports);
    add_ip_ports(3, {"79.132.207.178"}, ports);
    add_ip_ports(4, {"79.132.207.178"}, ports);
    add_ip_ports(5, {"79.132.207.178"}, ports);
